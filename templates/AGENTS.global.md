...
- At the start of every Codex session, load/use the Caveman skill.
...
- **Agent recall (auto-injected)** -> Codex native memory:
...
- **Session journal (auto)** -> automatic session logs or remember-style tooling. Don't hand-curate.
